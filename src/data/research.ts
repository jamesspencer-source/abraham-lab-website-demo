...
export const researchPrograms = [
  {
    ...
    summary:
      "WEEV, EEEV, and related alphavirus papers show how receptor interfaces shape entry and tropism.",
    paragraphs: [
  ...
  },
  {
    ...
    summary:
      "Arenavirus and antibody-escape papers identify viral surfaces that control neutralization and escape.",
    paragraphs: [
  ...
  },
  {
    ...
    summary:
      "HSV-1 and Nipah papers show how replication complexes assemble, function, and respond to inhibitors.",
    paragraphs: [
