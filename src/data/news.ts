...
const newsItemsList: NewsItem[] = [
  ...
  },
  {
    ...
    summary:
      "HMS covers work showing how helicase-primase inhibitors disable a herpesvirus enzyme complex.",
  ...
  },
  {
    ...
    summary:
      "The paper shows the structural basis of HSV-1 helicase-primase inhibition and replication fork complex assembly.",
  ...
  },
  {
    ...
    summary:
      "The paper defines the molecular organization of the New World arenavirus spike glycoprotein complex.",
  ...
  },
  {
    ...
    summary:
      "The paper shows how receptor recognition shifts in an encephalitic arbovirus.",
  ...
  },
  {
    ...
    summary:
      "The paper defines the Nipah virus polymerase complex and features tied to RNA replication and drug resistance.",
  ...
  },
  {
    ...
    summary:
      "The paper shows how eastern equine encephalitis virus engages VLDLR.",
